...
function DarkThemeContextProvider({ children }) {
  ...
  return (
    <DarkThemeContext.Provider value={darkTheme}>
      <DarkThemeDispatchContext.Provider value={setDarkTheme}>
        {children}
...
const useDarkThemeContext = () => { return useContext(DarkThemeContext) }
const useDarkThemeDispatchContext = () => { return useContext(DarkThemeDispatchContext) }
