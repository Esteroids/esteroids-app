    ...
    <div className='container  info-page'>
      <div className='row py-3 px-3 info-body'>
        <div className='col-md-6'>
          ...
          <p>
            This Privacy Policy discloses the type of information that is collected and recorded by Esteroids and how we
            use it.
          </p>

          <p className='text-success'>
            <b>
              ✉️ If you have additional questions or require more information about our Privacy Policy, do not hesitate
              to contact us by email at contact@esteroids.xyz.
            </b>
          </p>
          <h3>Log files</h3>
          ...
          <p>
            Your visit is completely private as far as Esteroids is concerned, we do not save your personal information.
          </p>

          <p>
            However, you should keep in mind that Esteroids is served using ENS and IPFS. Make sure to check the privacy
            policies of ENS and IPFS to get the full picture of accessing Esteroids.
          </p>
