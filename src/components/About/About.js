        ...
        <div className='row py-3 px-3 info-body'>
          <div className='col-md-6'>
            <div>
              ...
              <p>
                Three important properties of .eth websites are that they are private, robust, and
                censorship-resistance. Let&apos;s see what each of those properties means:
              </p>

              <p>
                <u>Privacy</u>: .eth websites are private to use. ENS+IPFS are decentralized networks, therefore using
                the websites you don&apos;t directly interact with their owner.
              </p>
              ...
              <p>
                A fourth important property is that .eth websites can be community websites. This happens when an
                on-chain community collectively owns an ENS name that has a .eth website.
              </p>
              ...
              <p>
                <span style={{ fontWeight: 'bold' }}>
                  See our <a href='https://docs.esteroids.xyz/'>docs</a> for more information on what Esteroids is and
                  how it works.
                </span>
              </p>
